...
public class TobaccoOptimizationInitialRoute {
    ...
    public static void main(String[] args) throws IOException {
        ...
        * Problem builder
         ...
         */
        new CustomReader3(vrpBuilder).read("input/temp_initroute");

        // Add initial route
        VehicleRoute initialRoute = VehicleRoute.Builder
            .newInstance(getVehicle("LTC726_day1", vrpBuilder)) //LTC726
            .addPickup(getShipment("100758_day1", vrpBuilder))
            .addPickup(getShipment("100556_day1", vrpBuilder))
            .addPickup(getShipment("102019_day1", vrpBuilder))
            .addPickup(getShipment("100559_day1", vrpBuilder))
            .addPickup(getShipment("102026_day1", vrpBuilder))
            .addDelivery(getShipment("100758_day1", vrpBuilder))
            .addDelivery(getShipment("100556_day1", vrpBuilder))
            .addDelivery(getShipment("102019_day1", vrpBuilder))
            .addDelivery(getShipment("100559_day1", vrpBuilder))
            .addDelivery(getShipment("102026_day1", vrpBuilder))
            .build();
    ...
    private static Shipment getShipment(String shipmentId, VehicleRoutingProblem.Builder vrpBuilder) {
        for (Job j : vrpBuilder.getAddedJobs()) {
            if (j.getId().equals(shipmentId)) {
                return (Shipment) j;
            }
        }
        return null;
